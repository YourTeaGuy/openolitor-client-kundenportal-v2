<template>
  <div class="flex h-auto justify-center py-4">
    <div
      class="rounded-xl border-4 border-solid border-slate-200 bg-slate-100 px-3 pb-5 text-black text-opacity-80 hover:bg-white">
      <div class="mx-auto">
        <!-- Titel -->
